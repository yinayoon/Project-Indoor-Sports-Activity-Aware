...
public class PoolManager
{
    ...
    class Pool
    {
        ...
        public void Push(Poolable poolable)
        {
            ...
            Renderer[] renderer = poolable.transform.GetComponentsInChildren<Renderer>();

            poolable.gameObject.GetComponent<HumanSet>().id = null;
        ...
        public Poolable Pop(Transform parent)
        {
            ...
            if (parent == null)
                poolable.transform.parent = GameObject.Find("Plane").transform;
